...
import UserCardContainer from "../components/left/userCardContainer";
...
import UserCardTopContainer from "../components/right/userCardTopContainer";
    ...
    <div className="App flex flex-row">
      <div className="left border-r border-border-color flex flex-col flex-shrink-0 flex-grow-0">
        ...
        <div className="list-friend-bottom overflow:hidden h-10/12">
          ...
          >
            <UserCardContainer selectID={props.id} obj={testObj} navigate={navigate} />
          </div>
        </div>
      </div>
      <div className="right">
        {props.noid ? <></> :
          <div id={props.id} className="right-container flex flex-col h-full">
            <div className="friend-top-right-container border-b border-border-color h-14">
              <div className="friend-container h-full flex flex-row justify-between px-2.5 py-1">
                <UserCardTopContainer obj={testObj} />
