...
class ContactCardContainer extends Component {
    ...
    render() {
        ...
        return (
            <div id={this.userInformation.id} className={(this.selectID == this.userInformation.id?" select ":"") +" my-1 item-friend-container p-2.5 h-17 box-border hover:bg-f2f2f2 hover:rounded-lg cursor-pointer "+ this.props.className} onClick={(event) => this.handleOnClick(event, this.userInformation.id)}>
